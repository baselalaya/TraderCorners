          ...
          {accounts.map((account, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <motion.button 
                  onClick={() => {
                    const url = account.buttonText.toLowerCase().includes('demo')
                      ? 'https://my.tradercorners.com/en/register/demo/demo-account-types'
                      : 'https://my.tradercorners.com/en/register/account-types';
